...
const MapFilter = ({
  ...
  const [userLoc, setUserLoc] = useRecoilState(mapUser);
  ...
  const obtenerCoordenadas = async (address) => {
    ...
    const direccionComplete = `${country} ${regionState} ${address}`;
    ...
    try {
      ...
      console.error("Ha ocurrido un error al animar la región: ", error);
    }
  };
  useEffect(() => {}, []);
  return (

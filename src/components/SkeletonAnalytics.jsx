...
const SkeletonExample = () => {
  ...
  return (
    ...
    >
      <View
        style={{ flexDirection: "row", marginBottom: 5, paddingHorizontal: 20 }}
      >
        {/* <View style={{ marginRight: 5 }}>
          <Skeleton width={160} height={150} style={{ marginBottom: 5 }} />
          <Skeleton width={160} height={150} />
        </View> */}
        <Skeleton width={325} height={200} />
      </View>
      ...
      <View style={{ flexDirection: "row-reverse", paddingHorizontal: 20, marginTop: 5 }}>
        <View style={{ marginLeft: 5 }}>
          <Skeleton width={160} height={305} />
        </View>
        <Skeleton width={160} height={305} />

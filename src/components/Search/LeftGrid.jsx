...
const LeftGrid = ({ data, input }) => {
  return (
    <View style={{ paddingHorizontal: 10, flexDirection: 'row'}}>
        ...
        {data[0] && <Post input={input} data={data[0]} image={data[0].thumbnail} styled={styles.bigColumn}/>}
      </View>
      ...
      {data[1] && <Post input={input} data={data[1]} image={data[1].thumbnail} styled={styles.column}/>}
        ...
        {data[4] && <Post input={input} data={data[4]} image={data[4].thumbnail} styled={styles.column}/>}
      </View>

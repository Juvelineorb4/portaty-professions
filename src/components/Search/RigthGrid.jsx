    ...
    <View style={{ paddingHorizontal: 10, flexDirection: 'row'}}>
      <View style={styles.rightGridContainer}>
        <TouchableOpacity
          style={styles.column}
          //   onPress={() =>
          //     navigation.navigate(data[0].link, {
          //       data: data[0].item,
          //     })
          //   }
        >
        ...
        <TouchableOpacity
          style={styles.column}
          //   onPress={() =>
          //     navigation.navigate(data[1].link, {
          //       data: data[1].item,
          //     })
          //   }
        >
        ...
        <TouchableOpacity
          style={styles.column}
          //   onPress={() =>
          //     navigation.navigate(data[2].link, {
          //       data: data[2].item,
          //     })
          //   }
        >
        ...
        <TouchableOpacity
          style={styles.column}
          //   onPress={() =>
          //     navigation.navigate(data[3].link, {
          //       data: data[3].item,
          //     })
          //   }
        >
      ...
      <View style={styles.bigContainer}>
        <TouchableOpacity
          ...
          //   onPress={() =>
          //     navigation.navigate(data[4].link, {
          //       data: data[4].item,
          //     })
          //   }
        >

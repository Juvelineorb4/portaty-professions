  ...
  async function getCountryCode(array) {
    ...
    array.map((item, index) => {
      if (!countryCode || countryCode === "--") {
        if (item.cca2 === "VE") setCountry(item);
        return;
      }
          ...
          <View style={[styles.modalContent]}>
            ...
            <View style={[styles.modalMid]}>
              <CustomInput
                ...
                defValue={data === undefined ? "" : data?.business?.name}
              ...
              <CustomInput
                ...
                defValue={data === undefined ? "" : data?.business?.email}
            ...
            <View style={[styles.modalBott]}>
              ...
              >
                ...
                <Feather name="arrow-right-circle" size={30} color="#1f1f1f" />
              </Pressable>
            </View>
          </View>
        </ScrollView>
